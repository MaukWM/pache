...
```bash
APP_TAG=0.1.0 docker compose -f docker-compose.release.yml up -d
```

Image: [`ghcr.io/maukwm/iwkisgwitnwk2`](https://github.com/MaukWM/iwkisgwitnwk2/pkgs/container/iwkisgwitnwk2)
(tags: `latest`, `0.1.0`, `0.1`).
